...
def parse_args():
    ...
    parser.add_argument("--list-formats", action="store_true", help="Desired video resolution (e.g., 1080p, 720p)")
    ...
    try:
        download(args.url, list_formats=args.list_formats, resolution=args.resolution, with_subs=args.with_subs)
